...
features_type=$1
python /home/reutme/TNBC_FLIM/flim_analysis/gnn_clssification/train_model/local_train_model_one_patch_size_shuffling_main.py $SLURM_ARRAY_TASK_ID $features_type