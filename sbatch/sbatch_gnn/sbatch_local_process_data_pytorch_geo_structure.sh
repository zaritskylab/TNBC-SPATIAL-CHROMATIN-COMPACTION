...
#SBATCH --time 0-11:30:00                      ### limit the time of job running. Make sure it is not greater than the partition time limit!! Format: D-H:MM:SS
...
python3 /home/reutme/TNBC_FLIM/flim_analysis/gnn_clssification/create_pytorch_geo_data/local_process_data_pytorch_geo_structure_main.py