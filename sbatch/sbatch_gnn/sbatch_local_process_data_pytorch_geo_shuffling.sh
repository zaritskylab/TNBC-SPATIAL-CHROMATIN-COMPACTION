...
#SBATCH --array=3-19             # Array indices (one for each task)
...
features_type=$1
python3 /home/reutme/TNBC_FLIM/flim_analysis/gnn_clssification/create_pytorch_geo_data/local_process_data_pytorch_geo_shuffling_main.py $SLURM_ARRAY_TASK_ID $features_type